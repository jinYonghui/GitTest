...
/**
CREATE TABLE tb_sm_wl_info(_id varchar2(32)
 primary key,new_code varchar2(30),old_code varchar2(30),wl_name varchar2(200),k
3_name varchar2(200),model_no varchar2(200),type_id varchar2(32),status integer,
wl_desc varchar2(200),cp_newcode varchar2(200),typeflag integer,base_unit varcha
r2(50))
*/
