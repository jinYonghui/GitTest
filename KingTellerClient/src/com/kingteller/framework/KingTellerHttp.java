...
import com.kingteller.framework.http.HttpHandler;
import com.kingteller.framework.http.RetryHandler;
import com.kingteller.framework.http.SyncRequestHandler;
...
public class KingTellerHttp {
    ...
    private static int socketTimeout = 60 * 1000; //超时时间，默认10秒
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
        	Thread tread = new Thread(r, "KingTellerHttp #" + mCount.getAndIncrement());
    ...
    */
	...
	public void post(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
        post(url, paramsToEntity(params,callBack), null, callBack);
    }
    ...
    public <T> void post( String url, Header[] headers, AjaxParams params, String contentType,AjaxCallBack<T> callBack) {
        ...
        if(params != null) request.setEntity(paramsToEntity(params,callBack));
        if(headers != null) request.setHeaders(headers);
  ...
  //------------------put 请求-----------------------
    ...
    public void put( String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
        put(url, paramsToEntity(params,callBack), null, callBack);
    }
     ...
     * @return
     */
    private HttpEntity paramsToEntity(AjaxParams params,AjaxCallBack<? extends Object> callBack) {
        HttpEntity entity = null;

        if(params != null) {
            entity = params.getEntity();
            if(params.getClass().getName().equals(AjaxFilesParams.class.getName()))
            {
            	((AjaxFilesParams) params).setUploadCallBack(callBack);
            }
        }
