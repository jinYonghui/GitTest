...
public class AllSjpaperListAdapter extends BaseAdapter {
	...
	public View getView(final int postion, View v, ViewGroup parent) {
		...
		Log.e("11111111111111111", postion + "");
		if (v == null) {
			viewHoler = new ViewHoler();
			v = inflater.inflate(R.layout.item_mypxkhsjlist, null);
			viewHoler.sjpaper_code_value = (TextView) v
					.findViewById(R.id.sjpaper_code_value);
			viewHoler.sjpaper_content_value = (TextView) v
					.findViewById(R.id.sjpaper_content_value);
			viewHoler.sjpaper_timeLong_value = (TextView) v
					.findViewById(R.id.sjpaper_timeLong_value);
			viewHoler.sjpaper_answerDate_value = (TextView) v
					.findViewById(R.id.sjpaper_answerDate_value);
			v.setTag(viewHoler);
		} else {
		...
		viewHoler.sjpaper_timeLong_value.setText(sjPaperbean.getTimeLong()
				+ "分钟");
		viewHoler.sjpaper_answerDate_value.setText(sjPaperbean
				.getAnswerDateLike());
		v.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				new KTAlertDialog.Builder(context)
						.setTitle("考核注意：")
						.setMessage(
								"1，考核期间不能做有关考核之外的任何操作"
										+ "(包括返回操作，home键操作)，直到试卷提交为止；" + "\n"
								...
								new KTAlertDialog.OnClickListener() {
									...
									public void onClick(
										...
										intent.putExtra("paperId",
												sjPaperbean.getPaperId());
										intent.putExtra("timeLong",
												sjPaperbean.getTimeLong());
										intent.setClass(context,
												DoPxkhSjActivity.class);
