...
public class WaitDoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHoler.item_num = (TextView) convertView
					.findViewById(R.id.item_num);
			viewHoler.item_time = (TextView) convertView
					.findViewById(R.id.item_time);
			viewHoler.item_sender = (TextView) convertView
					.findViewById(R.id.item_sender);
		...
		if (!CommonUtils.isEmpty(data.getSendTime())) {
		...
		if (!CommonUtils.isEmpty(data.getSenderName())
				&& !data.getSenderName().equals("null")) {
		...
		if (viewHoler.item_sender.getVisibility() == View.GONE
				&& viewHoler.item_time.getVisibility() == View.GONE) {
