...
public class LoadingObj {
	...
	public LoadingObj(Activity activity) {
		...
		layout_data_loading = (LinearLayout) activity
				.findViewById(R.id.layout_data_loading);

		layout_no_data = (LinearLayout) activity
				.findViewById(R.id.layout_no_data);
		layout_net_error = (LinearLayout) activity
				.findViewById(R.id.layout_net_error);
		layout_tip = (LinearLayout) activity.findViewById(R.id.layout_tip);

		text_data_loading = (TextView) activity
				.findViewById(R.id.text_data_loading);
